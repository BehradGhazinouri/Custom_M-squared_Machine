...
class MainFrame(wx.Frame):
    def __init__(self):
        ...
        self._add_ax_button(p, 171, (100, 25), (5, 55))
        self._add_ax_button(p, 172, (100, 25), (110, 55))
        ...
        wx.StaticText(p, label="Pos:", pos=(160, 365))
        self.pos_display = wx.StaticText(p, label="0", pos=(195, 365))
